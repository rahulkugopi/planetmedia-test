    ...
    <div data-testid='footer'>
      <footer className="bg-zinc-900 dark:bg-gray-900 mt-20">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between text-center lg:text-left">
            ...
            <ul className="flex flex-wrap items-center mt-2 lg:mt-0 justify-center text-sm text-gray-500 sm:mb-0 text-white">
              ...
              <li><Link to="/blog" className="mr-4 hover:underline md:mr-6 font-semibold">Blog</Link></li>
      ...
      <div className="block">
        <p className="text-sm pt-4 pb-4 bg-black text-gray-500 sm:text-center dark:text-gray-400 text-white font-semibold text-center">

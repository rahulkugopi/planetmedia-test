...
function Footer() {
  return (
    <div data-testid='footer'>
      <footer className="bg-slate-300 dark:bg-gray-900 mt-20">
      ...
      <div className="block text-sm pt-2 pb-2 bg-slate-400 text-gray-500 sm:text-center dark:text-gray-400">© 2023 All Rights Reserved.</div>
